...
var api = new ParseServer({
    ...
    push: {
        ...
        ios: [{
              ...
              {
                pfx: __dirname + '/iPhoneP12/com.satoshogoChineseLao store.p12',
                bundleId: 'com.satoshogoChineseLao',
                production: true
            }, 
              {
              ...
              {
                pfx: __dirname + '/iPhoneP12/com.satoshogoChineseFinnish store.p12',
                bundleId: 'com.satoshogoChineseFinnish',
                production: true
            }, 
              {
                pfx: __dirname + '/iPhoneP12/com.satoshogoRussianChinese store.p12',
                bundleId: 'com.satoshogoRussianChinese',
                production: true
            }, 
              {//com.satoshogoSimpleTraditional store.p12
